...
export default function Header() {
    ...
    return (
        <div className="lgh-24 h-20 w-full bg-[#252525] flex justify-between items-center py-10 lgpx-20 p-5 border-b-2 border-[#EFBF04] shadow-md">
            <img
                src="images/pbc_logo.png"
                alt="PRO BILLIARD CENTER"
                className="lgh-24 h-14"
            />
            <div>
